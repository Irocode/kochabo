...
class SofunktioniertesRepository extends Validator implements BaseRepositoryInterface
                ...
                public function all()
                                ...
                                {
                                return $this->sofunktioniertes->orderBy('created_at', 'DESC')->where('is_published', 1)->get();
                                }
                ...
                public function paginate($perPage = null, $all = false)
                                ...
                                {
                                if ($all) return $this->sofunktioniertes->orderBy('created_at', 'DESC')->paginate(($perPage) ? $perPage : $this->perPage);
                                return $this->sofunktioniertes->orderBy('created_at', 'DESC')->where('is_published', 1)->paginate(($perPage) ? $perPage : $this->perPage);
                                }
                ...
                public function togglePublish($id)
                                ...
                                return Response::json(array(
                                                'result' => 'success',
                                                'changed' => ($sofunktioniertes->is_published) ? 1 : 0
                                ));
                                }
                }
