...
public function all() {
return $this->deliveryzipcode->orderBy('zip', 'ASC')
...
$affectedRows = Deliveryzipcode::where('id', '=', $id)->update(array('zip' => $zip));
$deliveryzipcode->save();
$deliveryzipcode = $this->deliveryzipcode->find($id);
$deliveryzipcode->is_published = ($deliveryzipcode->is_published) ? false : true;
$deliveryzipcode->save();
return Response::json(array('result' => 'success', 'changed' => ($deliveryzipcode->is_published) ? 1 : 0));
return true;
}
