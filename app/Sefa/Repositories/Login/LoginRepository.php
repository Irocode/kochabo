...
class LoginRepository extends Validator implements BaseRepositoryInterface
                ...
                public function all()
                                ...
                                {
                                return $this->login->orderBy('created_at', 'DESC')->where('is_published', 1)->get();
                                }
                ...
                public function paginate($perPage = null, $all = false)
                                ...
                                {
                                if ($all) return $this->login->orderBy('created_at', 'DESC')->paginate(($perPage) ? $perPage : $this->perPage);
                                return $this->login->orderBy('created_at', 'DESC')->where('is_published', 1)->paginate(($perPage) ? $perPage : $this->perPage);
                                }
                ...
                public function togglePublish($id)
                                ...
                                return Response::json(array(
                                                'result' => 'success',
                                                'changed' => ($login->is_published) ? 1 : 0
                                ));
                                }
                }
