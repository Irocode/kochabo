...
public function all() {
return $this->deliveryassign->orderBy('name', 'ASC')
...
$affectedRows = Deliveryassign::where('id', '=', $id)->update(array('name' => $name, 'delivery_time_from' => $delivery_time_from, 'delivery_time_to' => $delivery_time_to, 'nightjump' => $nightjump));
$deliveryassign->save();
...
$deliveryassign->save();
return Response::json(array('result' => 'success', 'changed' => ($deliveryassign->is_published) ? 1 : 0));
return true;
}
}