...
<div class="container">
   ...
   {{ Form::open(array('action' => 'App\Controllers\Admin\IngredientsController@store')) }}
   <div class="row">
      <div class="col-md-6">
         <br> 
         <!-- name -->
      ...
      <div class="col-md-6">
         ...
         <div class="control-group {{ $errors->has('image') ? 'has-error' : '' }}">
            ...
            <div class="controls">
               {{ Form::textarea('image', null, array('class'=>'form-control', 'id' => 'image', 'placeholder'=>'Bild einfügen', 'value'=>Input::old('image'))) }}
