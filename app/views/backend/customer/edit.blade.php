...
<div class="container">
   ...
   {{ Form::open( array( 'action' => array( 'App\Controllers\Admin\CustomerController@update', $customer->id), 'method' => 'PATCH')) }}

    <!-- gender -->
      <div class="control-group {{ $errors->has('gender') ? 'has-error' : '' }}">
      <label class="control-label" for="gender">Anrede</label>
      <div class="controls " >
      <?php $genderselectchoice =$customer->gender;     
   ...
   <div class="control-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('first_name', $customer->first_name, array('class'=>'form-control', 'id' => 'first_name', 'placeholder'=>'Vorname', 'value'=>Input::old('first_name'))) }}
   ...
   <div class="control-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('last_name', $customer->last_name, array('class'=>'form-control', 'id' => 'last_name', 'placeholder'=>'Nachname', 'value'=>Input::old('last_name'))) }}
  ...
  <div class="input-group date form_date col-md-15" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
            {{ Form::text('datetime', $customer->datetime, array('class'=>'form-control', 'id' => 'datetime', 'placeholder'=>'Geburtsdatum', 'value'=>Input::old('datetime'))) }}
...
<br>
   ...
   <div class="control-group {{ $errors->has('kundeseit') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('kundeseit', $customer->kundeseit, array('class'=>'form-control', 'id' => 'kundeseit', 'placeholder'=>'Kunde seit', 'value'=>Input::old('kundeseit'))) }}
   ...
   <div class="control-group {{ $errors->has('abobox') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('abobox', $customer->abobox, array('class'=>'form-control', 'id' => 'abobox', 'placeholder'=>'Abo Box', 'value'=>Input::old('abobox'))) }}
         @if ($errors->first('title'))
   ...
   <div class="control-group {{ $errors->has('abolieferung') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('abolieferung', $customer->abolieferung, array('class'=>'form-control', 'id' => 'abolieferung', 'placeholder'=>'Abo Lieferung', 'value'=>Input::old('abolieferung'))) }}
   ...
   <div class="control-group {{ $errors->has('aboweine') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('aboweine', $customer->aboweine, array('class'=>'form-control', 'id' => 'aboweine', 'placeholder'=>'Abo Weine', 'value'=>Input::old('aboweine'))) }}
   ...
   <div class="control-group {{ $errors->has('abobiere') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('abobiere', $customer->abobiere, array('class'=>'form-control', 'id' => 'abobiere', 'placeholder'=>'Abo Biere', 'value'=>Input::old('abobiere'))) }}
   ...
   <div class="control-group {{ $errors->has('anzahlobstboxen') ? 'has-error' : '' }}">
      ...
      <div class="controls">
         {{ Form::text('anzahlobstboxen', $customer->anzahlobstboxen, array('class'=>'form-control', 'id' => 'anzahlobstboxen', 'placeholder'=>'Anzahl Obstboxen', 'value'=>Input::old('anzahlobstboxen'))) }}
 ...
 <!-- Plichtfeld Ende -->
   ...
   <!--
      <div class="control-group {{ $errors->has('is_published') ? 'has-error' : '' }}">
          ...
          <div class="controls">
              <label class="checkbox">{{ Form::checkbox('is_published', 'is_published',$customer->is_published) }} Veröffentlichen ?</label>
