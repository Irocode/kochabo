...
<div class="container">
   ...
   {{ Form::open(array('action' => 'App\Controllers\Admin\List_GruppeController@store')) }}
   <div class="row">
      <div class="col-md-4">
         <!-- Title -->
         <div class="control-group {{ $errors->has('bezeichnung') ? 'has-error' : '' }}">
            ...
            <div class="controls">
               {{ Form::text('bezeichnung', null, array('class'=>'form-control', 'id' => 'bezeichnung', 'placeholder'=>'Gruppe', 'required','value'=>Input::old('bezeichnung'))) }}
