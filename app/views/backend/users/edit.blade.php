...
<div class="container">
   ...
   <div class="well">
      {{ Form::open(array(
      'action' => array('UseradminController@update', $user->id), 
      'method' => 'put',
      'class' => 'form-horizontal', 
      'role' => 'form'
      )) }}
      <div class="form-group {{ ($errors->has('email')) ? 'has-error' : '' }}" for="email">
         {{ Form::label('edit_email', 'Es-Mail', array('class' => 'col-sm-2 control-label')) }}
         <div class="col-sm-10">
   ...
   <div class="well">
      {{ Form::open(array(
      'action' => array('UseradminController@change', $user->id), 
      'class' => 'form-inline', 
      'role' => 'form'
      )) }}
