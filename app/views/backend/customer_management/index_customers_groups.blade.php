...
<div class="container">
   ...
   <div class="panel panel-default">
      <div class="panel-heading">
         <h3 class="panel-title">Kundengruppe verwalten</h3>
      </div>
         ...
         <div class="table-responsive">
            ...
            <script type="text/javascript" language="javascript" class="init">
               ...
               "language": {
                         ...
                         "sRowSelect": "multi",
                          "sSwfPath": "{{URL::to('assets/backend/plugins/tablesorter/TableTools-2.2.1/swf/copy_csv_xls_pdf.swf')}}",
                           "aButtons": [
                               ...
                               {
                                   "sExtends": "csv",                                
                                   "sFileName": "Kundengruppendaten.csv",
                            ...
                            
                               {
                                   ...
                                   "mColumns":[2,3,4,5,6,7],
                                   "bFooter": false,
                                    "sFileName": "Kundengruppendaten.pdf",
                       ...
                       "ajax": "../tablesorter_customer_management_customers_groups/{{$id}} ",
