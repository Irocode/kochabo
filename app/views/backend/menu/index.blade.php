            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response['result'] == 'success') {
                        var imagePath = (response['changed'] == 1) ? "{{url('/')}}/assets/img/backend/images/publish_16x16.png" : "{{url('/')}}/assets/img/backend/images/not_publish_16x16.png";
        ...
        <div class="panel-body">
            ...
            <div class="pull-left">
                <div class="btn-toolbar">
                    <a href="{{ URL::route('admin.menu.create') }}" class="btn btn-u">
                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Neues Menü erstellen
                    </a>
                </div>
            </div>
            <br>
