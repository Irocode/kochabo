...
<div class="container">
    ...
    <div class="control-group {{ $errors->has('title') ? 'has-error' : '' }}">
        ...
        <div class="controls">
            {{ Form::text('title', $page->title, array('class'=>'form-control', 'id' => 'title', 'placeholder'=>'Titel', 'value'=>Input::old('title'))) }}
   ...
   <div>
    ...
    <div class="control-group {{ $errors->has('is_published') ? 'has-error' : '' }}">
        ...
        <div class="controls">
            <label class="checkbox">{{ Form::checkbox('is_published', 'is_published',$page->is_published) }} Veröffentlichung ?</label>
    ...
    <br>
    <!-- Form actions -->
    {{ Form::submit('Änderung speichern', array('class' => 'btn btn-u')) }}
    {{ Form::close() }}
    <script>
