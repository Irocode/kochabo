        ...
        <div style="text-align: center" class="col-md-4 col-md-offset-4">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h5 class="text-center"><b>Passwort zurücksetzen</b></h5>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                            {{ Form::password('confirm_password', array('class' => 'form-control','placeholder'=>'Password wiederholen')) }}
                        </div>
                    </div>
                    ...
                    {{ Form::submit('Speichern', array('class' => 'btn btn-sm btn-primary btn-block', 'role'=>'button')) }}
                    {{ Form::close() }}
                </div>
            </div>
        </div>
