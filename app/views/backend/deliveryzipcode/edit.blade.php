...
<div class="container">
     ...
     <div class="headline">
      <h2> Bestehende Logistiker Postleitzahl updaten und erstellen   GEHT NOCH NICHT</h2>
 ...
 {{ Form::open( array( 'action' => array( 'App\Controllers\Admin\DeliveryzipcodeController@update', $deliveryzipcode->id), 'method' => 'PATCH')) }}
...
<div class="row">
  ...
  <!-- zip -->
   <div class="control-group {{ $errors->has('zip') ? 'has-error' : '' }}">
      ...
      <div class="controls">
             {{ Form::text('zip', $deliveryzipcode->zip, array('class'=>'form-control', 'id' => 'zip', 'placeholder'=>'Postleitzahl', 'value'=>Input::old('zip'))) }}
