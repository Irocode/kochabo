...
<div class="breadcrumbs margin-bottom-40">
   <div class="container">
      ...
      {{ Breadcrumbs::render('kochabobox', $kochabobox) }}   
   </div>
</div>
<!--/breadcrumbs-->
<?php
   ...
   Session::forget('price_adwein');
   Session::forget('price_adobstbox');
   Session::forget('price_produkt');
   Session::forget('summi_brummi');
   Session::forget('obstbox');
   Session::forget('wein');
   Session::forget('obstboxcheck');
   Session::forget('obstbox_checked');
   Session::forget('wein_checked');
      ...
      <div class="col-md-9">
         ...
         <div class="row servive-block servive-block-in margin-bottom-20">
            <div class="col-md-4">
               ...
               <form action="{{ URL::to('bestellung_add') }}" method="POST">
            ...
            <div class="col-md-4">
               ...
               <div class="pricing hover-effect">
                  <div class="pricing-head">
                     ...
                     <h4>
                        <i></i><y id="fuerzweiprice">41</y><i>.90</i><i>€</i> <span>Pro Monat</span>
                     </h4>
                  </div>
                  <ul class="pricing-content list-unstyled">
                     <li><i class="icon-tags"></i> kostenloser Versand </li>
                  ...
                  <div class="pricing-footer">
                     <p>Alle Preise inkl. Mwst. & Lieferung. </p>
                     <br>
                     <select name="produkttyp" class="form-control" onchange="_namexx(this.options[this.selectedIndex].value,this.options[this.selectedIndex].getAttribute('rel'))">
                        <option rel="41"  selected="selected" value="Classic + 3 Rezepte">Classic + 3 Rezepte</option>
                        <option rel="61"   value="Classic + 5 Rezepte">Classic + 5 Rezepte</option>
                        <option rel="40"   value="Vegetarisch + 3 Rezepte">Vegetarisch + 3 Rezepte</option>
                     </select>
                     <script>
                        function _namexx(id,rel) {
                        
                        
                        var str = (rel);
                          //alert(rel);
                          $( "#fuerzweiprice" ).text( str );    
                        }
            ...
            <div class="col-md-4">
               ...
               <div class="pricing hover-effect">
                  <div class="pricing-head">
                     ...
                     <h4>
                        <i></i>
                        <y id="famprice">79</y><i>.90</i><i>€</i> <span>Pro Monat</span>
                     </h4>
                  </div>
                  <ul class="pricing-content list-unstyled">
                     <li><i class="icon-tags"></i> kostenloser Versand </li>
                  ...
                  <div class="pricing-footer">
                     <p>Alle Preise inkl. Mwst. & Lieferung. </p>
                     <br>
                     <select name="produkttyp" class="form-control" onchange="_namexxfam(this.options[this.selectedIndex].value,this.options[this.selectedIndex].getAttribute('rel'))">
                        <option rel="61" value="Classic + 3 Rezepte">Classic + 3 Rezepte</option>
                        <option  rel="79" selected value="Classic + 5 Rezepte">Classic + 5 Rezepte</option>
                        <option  rel="60" value="Vegetarisch + 3 Rezepte">Vegetarisch + 3 Rezepte</option>
                     </select>
                     <script>
                        function _namexxfam(id,rel) {
                        
                        
                        var strfam = (rel);
                          //alert(rel);
                          $( "#famprice" ).text( strfam );    
                        }
         ...
         <blockquote class="hero-unify margin-bottom-40">
            <p>TIPP: Bestell im nächsten Schritt einfach die Obstbox dazu!</p>
            <small>Dein KochAbo-Team</small>
         </blockquote>
         <div class="tag-box tag-box-v2">
            <div class="row">
               <div class="col-md-5 search-img">
                  <img class="img-responsive" src="filemanager/userfiles/kochabobox/fruitbox_addon_info.png" alt="">
               </div>
               <div class="col-md-6">
                  ...
                  <li><i class="icon-ok color-green"></i> Einfach im nächsten Schritt dazu bestellen</li>
               </div>
            </div>
         </div>
