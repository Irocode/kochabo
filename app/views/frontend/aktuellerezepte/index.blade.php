...
{{ Breadcrumbs::render('aktuellerezepte', $aktuellerezepte) }}   
...
<div  class="container">    
 ...
 <div class="col-md-12 col-sm-12">
                <div class="col-md-12 col-sm-12">
                <a href="{{ URL::route('dashboard.aktuellerezepte.show', array('id'=>$v->id, 'slug'=>$v->slug)) }}">
                ...
                <a href="#" class="">
                    ...
                    <div style="clear: both">
                        ...
                        <p>
                        <a style="float: right" href="{{ URL::route('dashboard.aktuellerezepte.show', array('id'=>$v->id, 'slug'=>$v->slug)) }}" class="btn-u">Weiterlesen</a>
                        </p><br><br><br><br>
