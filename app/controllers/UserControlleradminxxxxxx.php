...
class UserControlleradmin extends BaseController {
    ...
    /**
     * Instantiate a new UserControlleradmin
     */
    ...
    public function store()
    {
        ...
        if( $result['success'] )
        {
         ...
         //  Session::flash('message', 'Erfolgreich angelegt');
            return Redirect::action('UserControlleradmin@create')
    ...
    public function update($id)
    {
        ...
        if( $result['success'] )
        {
            ...
            return Redirect::action('UserControlleradmin@show', array($id));

        } else {
            Session::flash('error', $result['message']);
            return Redirect::action('UserControlleradmin@edit', array($id))
                ->withInput()
    ...
    public function suspend($id)
    {
        ...
        if( $result['success'] )
        {
            ...
            Session::flash('error', $result['message']);
            return Redirect::action('UserControlleradmin@suspend', array($id))
                ->withInput()
