...
class NewsletterController extends BaseController
				...
				public function index()
								...
								return View::make('newsletter.index')->with('varibale_ausgabe', $varibale_ausgabe);
								}
				/**
				...
				public function store()
								...
								if ($validator->fails())
												{
												return Redirect::to('newsletter/create')->withErrors($validator)->withInput(Input::except('password'));
												}
								  else
												{
												// store
				...
				public function show($id)
								...
								return View::make('newsletter.show')->with('ausgabenl', $ausgabenl)->with('footer', $footer)->with('ausgabeuseralle', $ausgabeuseralle)->with('ausgabe', $ausgabe);
								}
				/**
				...
				public function edit($id)
								...
								return View::make('newsletter.edit')->with('ausgabenl', $ausgabenl);
								}
				/**
				...
				public function update($id)
								...
								if ($validator->fails())
												{
												return Redirect::to('newsletter/' . $id . '/edit')->withErrors($validator)->withInput(Input::except('password'));
												}
								  else
												{
												// store
