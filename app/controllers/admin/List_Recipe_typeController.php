...
public function store()
				...
				if ($validator->fails())
								...
								return Redirect::route('admin.list_recipe_type.create')->withErrors($validator)->withInput(Input::except('bezeichnung'));
								}
				  else
								{
...
public function update($id)
				...
				if ($validator->fails())
								...
								return Redirect::route('admin.list_recipe_type.edit')->withErrors($validator)->withInput(Input::except('bezeichnung'));
								}
				  else
								{
