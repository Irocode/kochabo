...
class NewsletteradminController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('backend.newsletter.index')
	...
	public function store()
	{
		...
		// process the login
		if ($validator->fails()) {
			return Redirect::to('admin.newsletter.create')
...
//$ausgabe = Users::find($id)->users ;
		...
		return View::make('backend.newsletter.show')
			->with('ausgaben_adminnewsletter', $ausgaben_adminnewsletter)
			->with('footer', $footer)
	...
	public function edit($id)
	{
		...
		return View::make('backend.newsletter.edit')
			->with('ausgaben_adminnewsletter', $ausgaben_adminnewsletter);
	}
	...
	public function update($id)
	{
		...
		// process the login
		if ($validator->fails()) {
			return Redirect::to('/admin/newsletter/' . $id . '/edit')
				->withErrors($validator)
				->withInput(Input::except('password'));
		} else {
			// store
