...
->subject('KochAbo.at Aktivierung E-Mail Rezepte');
});
return Redirect::to('newslettereintrag');
}
}
...
return View::make('frontend.newsletter.show')
...
return View::make('frontend.newsletter.edit')
->with('ausgabenl', $ausgabenl);
}
/**
...
if (isset($codex)){echo"Erfolgreich aktiviert";}  else  {echo"leer";};
$ausgabenlx->save();
