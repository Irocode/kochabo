...
class Customer extends BaseModel implements BaseModelInterface {
    ...
    public $fillable=['id','first_name', 'gender', 'last_name',  'datetime','kundeseit', 'abobox', 'abolieferung', 'abotyp', 'aboweine', 'abobiere', 'anzahlobstboxen','abostatus', 'gruppen' , 'is_published'];
