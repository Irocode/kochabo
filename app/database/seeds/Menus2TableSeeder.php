	...
	public function run()
	{
		...
		\DB::table('menus2')->insert(array (
			...
			array (
				...
				'is_published' => 1,
				'created_at' => '2014-04-01 17:52:26',
				'updated_at' => '2014-04-20 06:37:39',
			),
			2 => 
			array (
				'id' => 3,
				...
				'is_published' => 1,
				'created_at' => '2014-04-01 17:52:26',
				'updated_at' => '2014-04-20 06:37:45',
			),
			3 => 
			array (
				'id' => 4,
			...
			array (
				...
				'updated_at' => '2014-04-11 11:12:54',
			),
			8 => 
			array (
				'id' => 10,
				...
				'updated_at' => '2014-04-11 11:12:55',
			),
			9 => 
			array (
				'id' => 11,
				...
				'updated_at' => '2014-04-11 11:12:56',
			),
			10 => 
			array (
				'id' => 12,
			...
			array (
				'id' => 18,
				'title' => 'Beispielbox',
				'url' => 'http://127.0.0.1/laravel/kochabo/beispielbox',
				'order' => 5,
				'parent_id' => 0,
				'type' => 'custom',
				'option' => NULL,
			...
			array (
				...
				'url' => 'http://127.0.0.1/laravel/kochabo/sofunktioniertes',
				'order' => 2,
				'parent_id' => 0,
				'type' => 'custom',
				'option' => NULL,
			...
			array (
				'id' => 20,
				'title' => 'KochAbo-Box',
				'url' => 'http://127.0.0.1/laravel/kochabo/kochabobox',
				'order' => 3,
				'parent_id' => 0,
				'type' => 'custom',
				'option' => NULL,
			...
			array (
				'id' => 21,
				'title' => 'Obstbox',
				'url' => 'http://127.0.0.1/laravel/kochabo/obstbox',
				'order' => 4,
				'parent_id' => 0,
				'type' => 'custom',
				'option' => NULL,
