...
class AktuellerezepteTableSeeder extends Seeder {
	...
	public function run()
	{
		\DB::table('aktuellerezepte')->truncate();
        
		\DB::table('aktuellerezepte')->insert(array (
			0 => 
			array (
				'id' => 1,
				'title' => 'Lorem Lipsum',
				...
				'updated_at' => '2014-04-09 19:54:00',
				'is_published' => 0,
				'bild1' => '',
			),
			1 => 
			array (
				...
				'datetime' => '2014-04-01',
				'created_at' => '2014-04-01 17:52:26',
				'updated_at' => '2014-04-09 19:54:01',
				'is_published' => 0,
				'bild1' => '',
			),
			2 => 
...
',
				'slug' => 'den-perfekt-passenden-wein-mit-dazu-bestellen',
				'datetime' => '2014-04-01',
				'created_at' => '2014-04-01 19:08:41',
				'updated_at' => '2014-04-09 19:24:25',
				'is_published' => 1,
				'bild1' => '<p><img src="
...
<p style="text-align:left">Wir garantieren 100% Zufriedenheit - das gilt sowohl f&uuml;r unsere Produkte, als auch Lieferung und Kundenservic</p>
',
				'slug' => 'kostenlose-lieferung',
				'datetime' => '2014-04-02',
				'created_at' => '2014-04-02 18:38:27',
				'updated_at' => '2014-04-09 19:32:26',
				'is_published' => 1,
				'bild1' => '<p><img src="
