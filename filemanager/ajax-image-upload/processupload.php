...
$a_baseurl =$_SERVER['DOCUMENT_ROOT'];
$b_baseurl =$_SERVER['PHP_SELF'];

$e_baseurl = str_replace('processupload.php', 'uploads/', $b_baseurl);
$domainfertig="$a_baseurl$e_baseurl";

echo"$a_baseurl";
echo"<br>$b_baseurl";
echo"<br>$e_baseurl";
echo"<br>$domainfertig";
...
if(isset($_POST))
{
	...
	$DestinationDirectory	= $domainfertig; //specify upload directory ends with / (slash)
	...
	{
			die('Fehler! Kein Image gefunden'); // output error when above checks fail.
	}
